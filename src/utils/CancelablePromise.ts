...
class CancelablePromiseInternal<T = any> {
  ...
  constructor({
    ...
    promise = new Promise<T>((resolve, reject) => executor(resolve, reject, (onCancel) => {
    ...
    this.#promise = promise
      || new Promise<T>((resolve, reject) => executor(resolve, reject, (onCancel) => {
...
export type ICancelablePromise = typeof CancelablePromise;
